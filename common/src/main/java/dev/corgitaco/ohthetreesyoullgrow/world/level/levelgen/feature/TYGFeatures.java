...
public class TYGFeatures {
    public static Supplier<Feature<TreeFromStructureNBTConfig>> TREE_FROM_NBT_V1 = ModPlatform.INSTANCE.registerFeature(() -> new TreeFromStructureNBTFeature(TreeFromStructureNBTConfig.CODEC.stable()), "tree_from_nbt_v1");
